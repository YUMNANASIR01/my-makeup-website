...
import { HiCheckCircle, HiXCircle, HiPaperClip } from "react-icons/hi"; // New icons for status
...
const AdminPage = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50 to-emerald-100">
      {/* Sidebar */}
      <div className="w-64 bg-white shadow-xl transition-all ease-in-out duration-300">
        <div className="h-full flex flex-col justify-between">
          <div>
            ...
            <div className="space-y-4 p-6">
              <Link href="/dashboard">
                <button className="w-full text-left px-4 py-2 rounded-lg hover:bg-emerald-200 text-gray-700 transition-all">
                  Dashboard
                </button>
              </Link>
              <Link href="/orders">
          ...
          <div className="p-6 border-t border-gray-200 flex justify-between items-center">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg border border-gray-200 bg-blue-200 hover:bg-blue-300"
              >
                Next
              </button>
            </div>
...
//             <button
//               onClick={() => {
//                 // Log out logic (using Clerk for authentication)
//                 router.push("/logout");
//               }}
