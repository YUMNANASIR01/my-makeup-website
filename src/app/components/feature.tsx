      ...
      <section className="container mx-auto py-16 px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="border p-4 rounded-lg">
            ...
            <Link href={`http://localhost:3000/product-details?id=${encodeURIComponent(1)}&name=${encodeURIComponent('Jwellery and Earrings')}&price=${encodeURIComponent('$56.01')}&image=${encodeURIComponent('https://img.heroui.chat/image/fashion?w=400&h=400&u=matte_liquid_lipstick1')}&description=${encodeURIComponent('Long-lasting matte finish with rich color payoff')}`}>
          ...
          <div className="border p-4 rounded-lg">
            ...
            <Link href={`http://localhost:3000/product-details?id=${encodeURIComponent(2)}&name=${encodeURIComponent('Hydrating Lip Gloss')}&price=${encodeURIComponent('$44.15')}&image=${encodeURIComponent('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQGGwJYv_PXuviVLPjwDxxRqgGyVshbqSgh-g0gHNhkjzCdKfGFA84uO36bl2Oat0bbThQ&usqp=CAU')}&description=${encodeURIComponent('Non-sticky formula with vitamin E')}`}>
              <button className="text-blue-500">View Details</button>
            </Link>
          </div>
          ...
          <div className="border p-4 rounded-lg">
            ...
            <Link href={`http://localhost:3000/product-details?id=${encodeURIComponent(3)}&name=${encodeURIComponent('Cosrx')}&price=${encodeURIComponent('$118.43')}&image=${encodeURIComponent('https://www.makeupcityshop.com/cdn/shop/files/pL6Asc.8809598456242_360x.jpg?v=1742539722')}&description=${encodeURIComponent('Rich and smooth texture with a soft finish')}`}>
              <button className="text-blue-500">View Details</button>
            </Link>
          </div>
          ...
          <div className="border p-4 rounded-lg">
            ...
            <Link href={`http://localhost:3000/product-details?id=${encodeURIComponent(4)}&name=${encodeURIComponent('Beauty of Joseon - Glow Serum')}&price=${encodeURIComponent('$56.12')}&image=${encodeURIComponent('https://www.makeupcityshop.com/cdn/shop/files/BeautyOfJoseon-GlowDeepSerumRice_Alpha-Arbutin-30ml_83e22904-3e91-4798-a620-f28e2e0a2bf8_360x.jpg?v=1742540939')}&description=${encodeURIComponent('High-shine finish with a moisturizing effect')}`}>
              <button className="text-blue-500">View Details</button>
            </Link>
          </div>
          ...
          <div className="border p-4 rounded-lg">
            ...
            <Link href={`http://localhost:3000/product-details?id=${encodeURIComponent(5)}&name=${encodeURIComponent('Medicube - Glow Booster Serum')}&price=${encodeURIComponent('$47.78')}&image=${encodeURIComponent('https://www.makeupcityshop.com/cdn/shop/files/pLNLXJ.8809981339206_360x.jpg?v=1742539592')}&description=${encodeURIComponent('Smooth and creamy texture with intense color')}`}>
              <button className="text-blue-500">View Details</button>
            </Link>
          </div>
          ...
          <div className="border p-4 rounded-lg">
            ...
            <Link href={`http://localhost:3000/product-details?id=${encodeURIComponent(6)}&name=${encodeURIComponent('Sheglam - Color Bloom Matte Liquid Blush')}&price=${encodeURIComponent('$57.19')}&image=${encodeURIComponent('https://www.makeupcityshop.com/cdn/shop/files/Sheglam---Color-Bloom-Matte-Liquid-Blush---Risky-Business-2_360x.jpg?v=1696337286')}&description=${encodeURIComponent('Bold and vibrant red for every occasion')}`}>
              <button className="text-blue-500">View Details</button>
            </Link>
          </div>
          ...
          <div className="border p-4 rounded-lg">
            ...
            <Link href={`http://localhost:3000/product-details?id=${encodeURIComponent(7)}&name=${encodeURIComponent('Golden Heals')}&price=${encodeURIComponent('$118.73')}&image=${encodeURIComponent('https://img.heroui.chat/image/fashion?w=400&h=400&u=pink_satin_lipstick1')}&description=${encodeURIComponent('Satin finish with soft pink hues')}`}>
              <button className="text-blue-500">View Details</button>
            </Link>
          </div>
          ...
          <div className="border p-4 rounded-lg">
            ...
            <Link href={`http://localhost:3000/product-details?id=${encodeURIComponent(8)}&name=${encodeURIComponent('Classic Clothes')}&price=${encodeURIComponent('$91.31')}&image=${encodeURIComponent('https://img.heroui.chat/image/fashion?w=400&h=400&u=berry_lipstick1')}&description=${encodeURIComponent('Deep berry shade for a chic look')}`}>
              <button className="text-blue-500">View Details</button>
            </Link>
          </div>
        </div>
